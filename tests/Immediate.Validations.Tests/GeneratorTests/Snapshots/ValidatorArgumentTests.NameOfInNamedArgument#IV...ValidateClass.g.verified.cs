...
partial class ValidateClass : global::Immediate.Validations.Shared.IValidationTarget
{
	...
	public static  global::Immediate.Validations.Shared.ValidationResult Validate(ValidateClass? target, global::Immediate.Validations.Shared.ValidationResult errors)
	{
		...
		__ValidatePassword(errors, t, t.Password);
		__ValidateConfirmation(errors, t, t.Confirmation);
	...
	private static void __ValidatePassword(
	...
	private static void __ValidateConfirmation(
		global::Immediate.Validations.Shared.ValidationResult errors, ValidateClass instance, string target
	)
	{
		...
		{
			if (!global::MatchesAttribute.ValidateProperty(
					t
					, comparison: instance.Password
				)
			)
			{
				errors.Add(
					$"Confirmation",
					global::MatchesAttribute.DefaultMessage,
					new()
					{
						["PropertyName"] = $"Confirmation",
						["PropertyValue"] = t,
						["ComparisonName"] = "Password",
						["ComparisonValue"] = instance.Password,
					}
				);
			}
		}
